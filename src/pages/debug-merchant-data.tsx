            ...
            {merchant ? (
              <Box>
                ...
                <Box sx={{ mb: 2 }}>
                  ...
                  <Typography variant="body1">
                    {merchant.phoneNumber || 'Not available'}
                  </Typography>
                </Box>
                ...
                <Box sx={{ mb: 2 }}>
                  ...
                  <Typography variant="body1">
                    {merchant.businessAddress || 'Not available'}
                  </Typography>
                </Box>
            ...
            {localStorageData ? (
              <Box>
                ...
                <Box sx={{ mb: 2 }}>
                  ...
                  <Typography variant="body1">
                    {localStorageData.phoneNumber || 'Not available'}
                  </Typography>
                </Box>
                ...
                <Box sx={{ mb: 2 }}>
                  ...
                  <Typography variant="body1">
                    {localStorageData.businessAddress || 'Not available'}
                  </Typography>
                </Box>

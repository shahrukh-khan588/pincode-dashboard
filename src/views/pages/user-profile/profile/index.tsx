  ...
  return (
    <Grid container spacing={6} sx={{ display: 'flex', flexDirection: 'row-reverse' }}>
      ...
      <Grid item lg={4} md={5} xs={12}>
        ...
        <Card sx={{ mt: 6 }}>
          <CardHeader title='Quick Transfer' titleTypographyProps={{ variant: 'h6', fontSize: '1.1rem' }} subheader='Transfer to your bank account' />
          <Divider />
          <CardContent>
            <Stack spacing={4}>
              <Box>
                ...
                <FormControl fullWidth>
                  <Select value={selectedBank} onChange={(e) => setSelectedBank(e.target.value)} displayEmpty sx={{ minHeight: 50 }}>
                    <MenuItem value="">
              ...
              <Box>
                ...
                <Slider
                  ...
                  max={100000}
                  step={1000}
                  marks={[{ value: 1000 }, { value: 10000 }, { value: 15000 }, { value: 20000 }, { value: 25000 }, { value: 30000 }, { value: 35000 }, { value: 40000 }, { value: 45000 }, { value: 50000 }, { value: 55000 }, { value: 60000 }, { value: 65000 }, { value: 70000 }, { value: 75000 }, { value: 80000 }, { value: 85000 }, { value: 90000 }, { value: 95000 }, { value: 100000 }]}
                  sx={{
                    '& .MuiSlider-thumb': { backgroundColor: 'primary.main', '&:hover': { backgroundColor: 'primary.dark' } },
                    '& .MuiSlider-track': { backgroundColor: 'primary.main' },
                    '& .MuiSlider-rail': { backgroundColor: 'grey.300' }
                  }}
                />
              </Box>
              ...
              <Alert severity="info" icon={<Icon icon='mdi:clock-outline' />} sx={{ '& .MuiAlert-message': { width: '100%' } }}>
                <Box>
      ...
      <Grid item lg={8} md={7} xs={12}>
        <Grid container spacing={6}>
          <Grid item xs={12}>
            <Card>
              <CardHeader title='Balance Summary' titleTypographyProps={{ variant: 'h6', fontSize: '1.1rem' }} action={<Button variant='contained' startIcon={<Icon icon='mdi:cash-plus' />}>Request</Button>} />
              <Divider />
              <CardContent>
                <Grid container spacing={6}>
          ...
          <Grid item xs={12}>
            <Card>
              <CardHeader title='Balance Statistics' titleTypographyProps={{ variant: 'h6', fontSize: '1.1rem' }} subheader='Monthly balances' />
              <Divider />
              <CardContent>
                <BalanceAreaChart />
              </CardContent>
                ...
                <Stack spacing={3}>
                  ...
                  <Stack direction='row' spacing={3} alignItems='center' justifyContent='space-between'>
                    ...
                    <Stack direction='row' spacing={1}>
                      ...
                      <IconButton sx={{ bgcolor: '#1877F2', color: 'white', '&:hover': { bgcolor: '#0d6efd' } }}>
                        <Icon icon='mdi:facebook' />
                      </IconButton>
                      <IconButton sx={{ bgcolor: '#1DA1F2', color: 'white', '&:hover': { bgcolor: '#0d8bd9' } }}>
                        <Icon icon='mdi:twitter' />
                      </IconButton>
                      <IconButton sx={{ bgcolor: '#EA4335', color: 'white', '&:hover': { bgcolor: '#d32f2f' } }}>
                        <Icon icon='mdi:email' />
                      </IconButton>
                    </Stack>
                  </Stack>
                  <Button
                    ...
                    sx={{ mt: 2, py: 1.5, fontSize: '1rem', fontWeight: 600, background: 'linear-gradient(135deg, #667eea 0%, #764ba2 100%)', '&:hover': { background: 'linear-gradient(135deg, #5a6fd8 0%, #6a4190 100%)' } }}
                  >
                    Invite Friends Now
                  </Button>
                </Stack>
      ...
      {/* Transactions moved to Projects tab */}
    </Grid>
  )
}
